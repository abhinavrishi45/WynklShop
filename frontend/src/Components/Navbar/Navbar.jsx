...
const Navbar = () => {
  ...
  return (
    <div className="navbar">
      ...
      <img className = 'nav-dropdown'onClick={dropsown_toggle} src={nav_dropdown} alt="" />
      <ul ref={menuRef} className="nav-menu">
        <li onClick={() => { setMenu("shop")}}><Link style={{textDecoration: 'none'}} to='/'>
